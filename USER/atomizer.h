...
#define ATOMIZER_ADC1_CHANNEL ADC1_CHANNEL_4
#define ATOMIZER_ADC1_EXTI_PORT EXTI_PORT_GPIOD
#define ATOMIZER_ADC1_TRIGGER_CHANNEL ADC1_SCHMITTTRIG_CHANNEL4

//check the voltage on atomizer
#define ATOMIZER_ADC2_PORT GPIOD
#define ATOMIZER_ADC2_PIN  GPIO_PIN_2
#define ATOMIZER_ADC2_CHANNEL  ADC1_CHANNEL_3
#define ATOMIZER_ADC2_EXTI_PORT EXTI_PORT_GPIOD
#define ATOMIZER_ADC2_TRIGGER_CHANNEL ADC1_SCHMITTTRIG_CHANNEL3
